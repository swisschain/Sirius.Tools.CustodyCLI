...
{
    public class SignWithdrawalV1CommandRegistration : ICommandRegistration
    {
        private readonly CommandFactory _factory;

        public SignWithdrawalV1CommandRegistration(CommandFactory factory)
        {
            _factory = factory;
        }
        ...
        {
            lineApplication.Description = "Signs withdrawal v1 request.";
            ...
            var inOption = lineApplication.Option(
                "-i|--in <in>",
                "Path to JSON file containing withdrawal v1 request",
                CommandOptionType.SingleValue);
